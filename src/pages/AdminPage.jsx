...
import { Plus, Trash2, Edit2, Check, X, Lock } from 'lucide-react';
...
const AdminPage = ({ products, onAdd, onUpdate, onDelete, categories, formatPrice }) => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Simple demo credential. In real app, replace with proper auth.
    if (creds.user === 'admin' && creds.pass === 'mirai123') {
      setAuthed(true);
    }
  };
        ...
        <div className="container mx-auto px-6 py-16 flex flex-col gap-6">
          ...
          <div>
            ...
            <p className="text-stone-200 mt-3 max-w-2xl">
              Secure area to add, edit, and remove SKUs. Demo credentials: admin / mirai123.
            </p>
          </div>
        </div>
      </div>
