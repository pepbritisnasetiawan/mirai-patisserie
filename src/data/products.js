export const CATEGORIES = ["All", "Cakes", "Viennoiserie", "Seasonal", "Gifts"];

export const PRODUCTS = [
  {
    id: 1,
    name: "Yuzu Matcha Cloud",
    category: "Cakes",
    price: 12.50,
    description: "Ceremonial grade matcha mousse layered with yuzu curd and black sesame sponge.",
  ...
  {
    id: 2,
    name: "Noir Hazelnut Tart",
    category: "Seasonal",
    price: 9.00,
    description: "70% dark chocolate ganache, roasted hazelnut praline, and a sea salt cocoa crust.",
  ...
  },
  {
    ...
    category: "Cakes",
    price: 14.00,
    description: "A reimagined strawberry shortcake. Vanilla bean chiffon, diplomat cream, and fresh Amaou strawberries.",
  ...
  {
    id: 4,
    name: "Isigny Croissant",
    category: "Viennoiserie",
    price: 5.50,
    description: "27 layers of butter-laminated dough, baked to a deep golden amber. Sourced Isigny butter.",
  ...
  },
  {
    ...
    category: "Viennoiserie",
    price: 11.00,
    description: "Choux pastry ring filled with rich pistachio mousseline and tart raspberry compote.",
  ...
  {
    id: 6,
    name: "Earl Grey Financier Box",
    category: "Gifts",
    price: 24.00,
    description: "A box of 6 almond cakes infused with bergamot tea and honey.",
